...
if __name__ == "__main__":
    ...
    elif args.potential == "harmonic_interaction_specified":
        model = model.DTIHarmonicIS(args)
    else:
    ...
    if args.local_opt:
        for lf, pf, of, loof in zip(args.ligand_files,
                                    args.protein_files,
                                    args.output_files,
                                    args.ligand_opt_output_files):
        ...
        for lf, pf, of in zip(args.ligand_files,
                              args.protein_files,
                              args.output_files):
