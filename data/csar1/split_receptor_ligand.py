...
filenames = glob.glob(
    '../CSAR_NRC_HiQ_Set/Structures/set1/*/set1_*_complex.mol2')
# filenames += glob.glob('../CSAR_NRC_HiQ_Set/Structures/set2/*/set2_*_complex.mol2')

with open("./csar1.txt", "r") as f:
    lines = f.readlines()
...
for fn in filenames[:]:
    ...
    # if len(smiles_dic[pdb_id.upper()]) < 2:
    #     continue
    # print(pdb_id)
    # print(orig_ligand_resname)
    # print(smiles_dic[pdb_id.upper()])
